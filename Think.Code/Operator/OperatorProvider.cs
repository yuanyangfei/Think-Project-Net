...
namespace Think.Code
{
    public class OperatorProvider
    {
        ...
        private string LoginUserKey = "Think_loginuserkey_2016";
        ...
        public void AddCurrent(OperatorModel operatorModel)
        {
            ...
            WebHelper.WriteCookie("Think_mac", Md5.md5(Net.GetMacByNetworkInterface().ToJson(), 32));
            WebHelper.WriteCookie("Think_licence", Licence.GetLicence());
        }
